...
tags:
  - Multi-Agent Systems
  - Optimisation
image: /posts/multiagent-travellingsalesmanproblem/featured.png
description: "A summary of work on solving routing and allocation problems for multi-agent systems using a multi-demic evolutionary algorithm."
---
...
## Read the full paper
If you want to read in a bit more detail then you can find the full paper here: Kent, T. E. & Richards, A. G. Decentralised Multi-Demic Evolutionary Approach to the Dynamic Multi-Agent Travelling Salesman Problem. Genetic and Evolutionary Computation Conference (GECCO '19), 147–148 (2019). [DOI: 10.1145/3319619.3321993](https://doi.org/10.1145/3319619.3321993)
