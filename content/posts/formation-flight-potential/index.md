...
tags:
  - Formation Flight
image: /posts/formation-flight-potential/featured.jpg
description: "Showing the fuel-saving potential of commercial formation flight, with three airline case studies."
---

## Journal of Aircraft Paper

Follow on work from my PhD has recently been published in the [Journal of Aircraft](https://arc.aiaa.org/doi/10.2514/1.C035954) and is titled "Potential of Formation Flight for Commercial Aviation: Three Case Studies". 
...
Focusing on two-aircraft formations, the paper builds upon theory outlined in a [previous paper](https://doi.org/10.2514/1.G000806) which uses a three stage approach:
...
## Airbus Fello'fly 
Airbus's [fello'fly demonstrator project](https://www.airbus.com/en/innovation/energy-transition/aircraft-technologies/fello-fly) is putting these same wake-energy principles into practice, aiming to cut CO2 emissions by 3-4 million tonnes a year on widebody operations, while working through the operational challenges of flying two large aircraft close together.
...
At the time, initial flight tests were already underway, trialling pilot-assistance technology for flying safely in close formation, working towards oceanic airspace demonstrations and an eventual entry into service.

## Further reading

You can take a look at the paper: Kent, T., Richards, A. The Potential of Formation Flight for Commercial Aviation: Three Case Studies, Journal of Aircraft. [DOI: 10.2514/1.C035954](https://doi.org/10.2514/1.C035954)
