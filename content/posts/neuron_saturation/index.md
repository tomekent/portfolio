...
image: /posts/neuron_saturation/featured.png
description: "Exploring neuron saturation in a DDPG continuous-control policy for multi-agent persistent surveillance."
---
...
Some of our most recent work looks at whether we can simply train single agent policies like above and deploy them to multi agent problems - *without Multi-Agent RL*. It turns out we can, but there are catches. I recently gave a talk called ["Ignorance is bliss" on the role of noise and heterogeneity in training and deployment of single agent policies for the multi-agent persistent surveillance problem](/posts/collective-dynamics-seminar/) which goes into some more detail.
